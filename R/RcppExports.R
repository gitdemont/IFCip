...
cpp_rescale <- function(img, msk_ = NULL, value = NA_real_, n_lev = 256L, invert = FALSE, bin = FALSE, clipmin = NA_real_, clipmax = NA_real_, method = 1L) {
    .Call(`_IFCip_cpp_rescale`, img, msk_, value, n_lev, invert, bin, clipmin, clipmax, method)
}
